...
public class Vector3DArrayTest {
    ...
    public void testGetMaxLength() {
        double len = new Vector3D(2, 3, 2).lenVec();
    ...
    public void testGetSumOfVectors() {
        Vector3D sum = new Vector3D(4, 7, 8);
    ...
    public void testGetLinearCombinationWell() throws Exception {
        ...
        assertEquals(varray.lineCombination(koef), new Vector3D(3, 6, 9));
    }
